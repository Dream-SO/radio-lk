package com.dreamso.radiolk.player;
...
public class RadioService extends Service implements Player.EventListener, AudioManager.OnAudioFocusChangeListener {
    ...
    public static final String ACTION_PLAY = "com.mcakir.radiolk.player.ACTION_PLAY";
    public static final String ACTION_PAUSE = "com.mcakir.radiolk.player.ACTION_PAUSE";
    public static final String ACTION_STOP = "com.mcakir.radiolk.player.ACTION_STOP";
...
//        DefaultHttpDataSourceFactory dataSourceFactory = new DefaultHttpDataSourceFactory(getUserAgent());
        ...
        sessionID = exoPlayer.getAudioSessionId();
        Log.e("classSessionIDFirst", String.valueOf(sessionID));
    }
